...
- Наявність файлу requirements.txt (Виконано)
...
### 0. Винесіть токен в окремий файл. (Виконано)
Додайте цей файл до .gitignore.

### 1. *"Випадковий факт"* (ВИКОНАНО)
...
### 3. *"Діалог з відомою особистістю"* (ВИКОНАНО)
